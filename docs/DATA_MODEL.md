...
16 tables covering all entities defined in SYSTEM_DESIGN.md. Designed for PostgreSQL from the start — this is a new system built for multi-technician concurrency and real-time sync, so there is no SQLite-to-PostgreSQL migration to plan for later.
